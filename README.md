...
- **3D 角色预览** — 集成 skinview3d，在角色编辑时实时预览皮肤与披风效果；缩略图采用脸部/披风截取，还原 Minecraft 原生视觉
...
- **角色管理** — 创建多个游戏角色，每个角色拥有独立的 Yggdrasil Token，角色卡片展示脸部截取预览
- **皮肤 & 披风** — 上传、管理个人皮肤与披风资源，支持别名命名，公开/私有可控
- **材质库** — 公共材质广场，浏览所有公开的皮肤与披风，按热度（点赞 + 收藏×5）排序，无限滚动懒加载，未登录可预览前 100 条
- **点赞 & 收藏** — 为材质点赞助力上热门，收藏到个人共享材质库，收藏上限可由管理员配置
- **共享材质** — 好友共享 + 我的收藏双板块，一键设为角色皮肤/披风，支持自定义别名
- **好友系统** — 好友代码添加、好友详情卡片、拉黑管理，支持向好友共享材质（勾选列表）
- **3D 皮肤预览** — 集成 skinview3d，缩略图采用脸部截取展示，详情弹窗支持 360° 旋转预览
...
- [x] 好友功能
- [x] 皮肤库系统，以及可选纹理的私有/公开/好友共享/指定好友共享
- [x] 皮肤&披风的点赞收藏，按热度排序
- [x] 优化管理员设置的保存功能，更好更快
