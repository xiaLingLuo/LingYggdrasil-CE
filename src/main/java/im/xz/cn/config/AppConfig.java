...
import im.xz.cn.security.ConfigCipher;
...
public class AppConfig {
    private static final logApi log = logApi.getLogger(AppConfig.class);
    ...
    public void createInstalledFile() {
        try {
            ...
            log.error("Failed to create installed file: {}", e.getMessage(), e);
        }
    }
