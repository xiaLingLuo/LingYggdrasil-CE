...
public class SessionManager {
    ...
    public static void setAdminRoot(Context ctx, boolean root) {
        ctx.sessionAttribute("adminRoot", root);
    }

    public static boolean isAdminRoot(Context ctx) {
        return Boolean.TRUE.equals(ctx.sessionAttribute("adminRoot"));
    }

    public static void setAdminPermGroup(Context ctx, String permGroup) {
        ctx.sessionAttribute("adminPermGroup", permGroup);
    }

    public static String getAdminPermGroup(Context ctx) {
        return ctx.sessionAttribute("adminPermGroup");
    }
    ...
    public static String getLanguage(Context ctx) {
        return ctx.sessionAttribute("language");
    }
    ...
    public static void invalidateAdmin(Context ctx) {
        ...
        ctx.sessionAttribute("adminRoot", null);
        ctx.sessionAttribute("adminPermGroup", null);
    ...
    public static void invalidateAndRenewUser(Context ctx) {
        ...
        if (oldSession != null) {
            ...
            Object adminRoot = oldSession.getAttribute("adminRoot");
            String adminPermGroup = (String) oldSession.getAttribute("adminPermGroup");
            ...
            if (adminRoot != null) newSession.setAttribute("adminRoot", adminRoot);
            if (adminPermGroup != null) newSession.setAttribute("adminPermGroup", adminPermGroup);
