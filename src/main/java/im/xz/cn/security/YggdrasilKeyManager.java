...
public class YggdrasilKeyManager {
    private static final logApi logger = logApi.getLogger(YggdrasilKeyManager.class);
    ...
    public static final String MODE_RSA_SHA1 = "rsa-sha1";
    ...
    public void generateKeyPair(String mode) throws Exception {
        ...
        } else if (MODE_RSA_SHA512.equals(mode) || MODE_RSA_SHA1.equals(mode)) {
    ...
    public String sign(String data) {
        ...
        try {
            ...
            } else if (MODE_RSA_SHA1.equals(mode)) {
