...
(function() {
    async function loadSkins() {
        ...
        try {
            ...
            if (data.success && data.skins && data.skins.length > 0) {
                var html = '<div class="upload-tile card-animate" id="skinUploadTile">' +
                ...
                container.innerHTML = '<div class="upload-tile card-animate" id="skinUploadTile">' +
                    '<div class="upload-tile-icon">' +
                    '<svg viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>' +
                    '</div>' +
                    '<div class="upload-tile-text">上传皮肤</div>' +
    ...
    window.showSkinDetail = function(id, alias, originalName, hash, size) {
        ...
        visCheckbox.addEventListener('change', function() { toggleVisibility(id, this.checked); });
        ...
        fetchVisibility(id, visCheckbox);
    ...
    window.deleteSkin = function(id, name) {
        showConfirmDialog('\u786E\u5B9A\u8981\u5220\u9664\u76AE\u80A4 "' + name + '" \u5417\uFF1F\u6B64\u64CD\u4F5C\u4E0D\u53EF\u6062\u590D\u3002', function() {
    ...
    function showUploadModal(file) {
        ...
        box.innerHTML =
            ...
            '<input type="text" class="form-input" id="uploadAlias" placeholder="给皮肤起个名字吧">' +
            '</div>' +
