...
# 2. Download LingYggdrasil-2.1.0.jar and put it in a standalone empty directory
...
- **Plugin development API** — the build also produces `LingYggdrasil-plugin-api-2.1.0.jar`, self-contained, for plugin developers to compile against.
