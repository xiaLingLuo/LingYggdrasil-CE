...
# 2. Download LingYggdrasil-2.2.7.jar and put it in a standalone empty directory
...
- **Plugin development API** — the build also produces `LingYggdrasil-plugin-api-2.2.7.jar`, self-contained, for plugin developers to compile against.
