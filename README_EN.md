...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.3.5-blueviolet?style=flat-square" alt="Version" />
...
# 2. Download LingYggdrasil-2.3.5.jar and put it in a standalone empty directory
...
- **Plugin development API** — the build also produces `LingYggdrasil-plugin-api-2.3.5.jar`, self-contained, for plugin developers to compile against.
